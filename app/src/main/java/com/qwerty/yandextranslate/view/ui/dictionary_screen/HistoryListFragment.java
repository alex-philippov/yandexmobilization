...
public class HistoryListFragment extends MvpAppCompatFragment implements DictionaryListView {
    ...
    @InjectPresenter(type = PresenterType.GLOBAL, tag = HistoryListPresenter.TAG)
